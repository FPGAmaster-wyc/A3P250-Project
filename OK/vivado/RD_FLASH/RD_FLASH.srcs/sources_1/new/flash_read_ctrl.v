...
parameter   CNT_WAIT_MAX=   16'd2_0000 ;       //10M   10_0000_0000 / 9600
...
//********************************************************************//
//-------------fifo_data_inst--------------
uart_rx_data your_instance_name (
  ...
  ila_0 READ_ILA (
	...
	.probe0({sys_rst_n, key, miso, sck, cs_n, mosi, tx_flag, tx_data, state, 
                fifo_read_en, po_flag, po_data, fifo_data_num, read_data_num, fifo_read_valid,
                cnt_sck, cnt_byte, cnt_bit, cnt_clk}) // input wire [255:0] probe0
);
