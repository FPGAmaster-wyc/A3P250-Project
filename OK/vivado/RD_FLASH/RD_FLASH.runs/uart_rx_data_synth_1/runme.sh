...
HD_PWD='E:/my_work/A3P250/vivado/RD_FLASH/RD_FLASH.runs/uart_rx_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rx_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_rx_data.tcl
